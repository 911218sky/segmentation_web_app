...
class LineExtractor:
    ...
    def extract_vertical_lines_from_mask(
        img: np.ndarray,
        mask: np.ndarray,
        sample_interval: int = LINE_CONFIG['sample_interval'],
        gradient_search_top: int = LINE_CONFIG['gradient_search_top'],
        gradient_search_bottom: int = LINE_CONFIG['gradient_search_bottom'],
        keep_ratio: Optional[float] = LINE_CONFIG['keep_ratio'],
        ...
        lines = LineExtractor._filter_with_smoothing(lines,
                                                    window_size=LINE_CONFIG['window_size'], 
